...
class RecalboxMoonlightFormView(FormView):
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        self.config_filepath = settings.RECALBOX_MOONLIGHT_PATH
        self.config_content = self.get_config_file(self.config_filepath)
        
        self.backup_filepath = settings.RECALBOX_MOONLIGHT_BACKUP_PATH
        ...
        return super(RecalboxMoonlightFormView, self).dispatch(request, *args, **kwargs)
    ...
    def get_context_data(self, **kwargs):
        context = super(RecalboxMoonlightFormView, self).get_context_data(**kwargs)
        context.update({
    ...
    def get_form_kwargs(self):
        context = super(RecalboxMoonlightFormView, self).get_form_kwargs()
        context.update({
            'config_filepath': self.config_filepath,
            'backup_filepath': self.backup_filepath,
        })
    ...
    def form_valid(self, form):
        ...
        return super(RecalboxMoonlightFormView, self).form_valid(form)
